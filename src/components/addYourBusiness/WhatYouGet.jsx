    ...
    <div className='lg:w-7xl mx-auto mt-16'>
      ...
      <div className="flex justify-center items-center mt-24 bg-white">
        ...
        <div className="relative flex flex-col items-center w-full max-w-5xl">
          {/* Vertical Line */}
          <div className="hidden md:block absolute top-0 bottom-0 w-6 bg-blue-900 rounded-full"></div>

          {/* Targeted Exposure - Left */}
          <div className="relative flex flex-col md:flex-row w-full mb-12 mt-14">
            {/* Left Card */}
            <div className="w-full md:w-1/2 flex md:justify-end pr-0 md:pr-6 mb-6 md:mb-0">
              <div className="bg-white border border-blue-900 rounded-lg shadow-md w-full md:w-90 h-32">
          ...
          <div className="relative flex flex-col md:flex-row w-full mb-24">
            {/* Empty left side (only desktop) */}
            <div className="hidden md:block w-1/2"></div>
            ...
            {/* Right Card */}
            <div className="w-full md:w-1/2 flex md:justify-center pr-0 md:pr-5">
              <div className="bg-white border border-blue-900 rounded-lg shadow-md w-full md:w-90 h-32">
