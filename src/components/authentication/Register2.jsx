  ...
  return (
    <div>
        <div className='lg:w-[803px] lg:h-[516px] mx-auto mt-14 lg:shadow-2xl relative'>
                ...
                <h1 className='font-bold common-text text-4xl mt-12 montserrat-text text-center'>Marketing preferences</h1>
                <h3 className='text-center text-lg mt-2 montserrat-text'>Can we contact you with promotions and updates to help you get <br /> the most out of your Blue Light Card?</h3>
