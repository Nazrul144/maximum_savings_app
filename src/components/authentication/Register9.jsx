        ...
        <div className="flex justify-center mt-8 gap-6">
           ...
           <div className="w-[650px] mx-auto mt-8">
            ...
            <div>
             ...
             <div>
            <Label className='text-xl text-[#4F5B76] font-bold' htmlFor="card">Expiry</Label>
            <Input className='mt-2' type="email" placeholder="MM / YY" />
             </div>
             <div>
            <Label className='text-xl text-[#4F5B76] font-bold' htmlFor="card">CVC</Label>
            <Input className='mt-2' type="email" placeholder="CVC" />
             </div>
             <div>
            <Label className='text-xl text-[#4F5B76] font-bold' htmlFor="card">Country</Label>
            {/*Dropdown*/}
            <div >
            <DropdownMenu>
             ...
             <div>
            <Label className='text-xl text-[#4F5B76] font-bold' htmlFor="card">Postal code</Label>
            <Input className='mt-2' type="email" placeholder="90210" />
                    ...
                    <div className="flex justify-self-center mt-10 ">
                        <Button className='common-bg text-2xl py-8 px-10 cursor-pointer'>Submit</Button>
                    </div>
      </div>
    </div>
  );
